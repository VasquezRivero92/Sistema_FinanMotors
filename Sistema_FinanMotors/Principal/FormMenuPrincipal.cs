...
namespace Sistema_FinanMotors
{
    public partial class FormMenuPrincipal : Form
    {
        ...
        public static string cnn = "datasource=127.0.0.1;port=3306;username=root;password=;database=finanmotors;";

        public static string username, tienda = "";
        public static bool login = false;
        public static Panel panel_publico;
        //Constructor
        ...
        {
            MostrarFormLogo();
            using (MySqlConnection conn = new MySqlConnection(cnn))
            {
                try
                {
                    if (login == false)
                    {
                        ...
                        frmlogin.Text = "Registro de Clientes";
                ...
                {
                    MessageBox.Show("No se puede establecer la comunicacion con la base de datos " + ex);
                    this.Close();
                }
            }
            if (login == false)
